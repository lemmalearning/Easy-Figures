...
class Arrow:
	...
	def __init__(self, start, end, headWidth, headLength, lw, mplprops, figure):
		...
		self.head = self.figure.addPolygon([self.figure.px2unit_c(l_1).tolist()[0], self.figure.px2unit_c(end).tolist()[0], self.figure.px2unit_c(l_2).tolist()[0]], fill='k', mplprops={'fc':'k'})
